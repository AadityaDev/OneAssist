...
import com.technawabs.oneassist.base.BaseAppCompat;
import com.technawabs.oneassist.modal.UserDetails;

import java.util.concurrent.TimeUnit;

public class MobileNumberActivity extends BaseAppCompat {
...
//    private Button mSignOutButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobile.setText("9871552963");
        sendOTP = (CardView) findViewById(R.id.sendOTP);
        sendOTP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mobile.getText() != null && !mobile.getText().toString().isEmpty()&&mobile.getText().toString().length()==10) {
//                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
//                            mobile.getText(),        // Phone number to verify
//                            60,                 // Timeout duration
...
//                            mCallbacks);
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_SMS) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(getApplicationContext(),"Enter your mobile number",Toast.LENGTH_LONG);
            return;
        }else{
            String mPhoneNumber = tMgr.getLine1Number();
            if(mPhoneNumber!=null||!mPhoneNumber.isEmpty())
                mobile.setText(mPhoneNumber);
        }
